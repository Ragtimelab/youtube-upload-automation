...
class SuccessResponse(BaseResponse):
    ...
    @classmethod
    def create(cls, message: str = "작업이 성공적으로 완료되었습니다.", data: Any = None) -> "SuccessResponse":
...
class ErrorResponse(BaseResponse):
    ...
    @classmethod
    def create(cls, message: str, error_code: str = None, error_details: Dict[str, Any] = None) -> "ErrorResponse":
...
class ValidationErrorResponse(ErrorResponse):
    ...
    @classmethod
    def create(cls, message: str = "입력 데이터 검증에 실패했습니다.", 
              validation_errors: List[Dict[str, str]] = None) -> "ValidationErrorResponse":
...
class PaginatedResponse(SuccessResponse):
    ...
    @classmethod
    def create(cls, data: List[Any], total: int, skip: int = 0, limit: int = 100, 
              message: str = "조회가 완료되었습니다.") -> "PaginatedResponse":
        return cls(
            message=message,
            data=data,
            pagination={
...
class UploadResponse(SuccessResponse):
    ...
    def youtube_uploaded(cls, youtube_data: Dict[str, Any]) -> "UploadResponse":
        return cls.create(
            message="YouTube 업로드가 성공적으로 완료되었습니다.",
            data=youtube_data
        )
...
class HealthCheckResponse(SuccessResponse):
    ...
    @classmethod
    def unhealthy(cls, services: Dict[str, str] = None, message: str = "시스템에 문제가 발생했습니다.") -> "HealthCheckResponse":
        response = cls(
            success=False,
            message=message,
